...
import { fetchDiscountProducts } from "./fetchApi";
...
const DiscountOffers = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await fetchDiscountProducts();
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 py-16">
      <h2 className="text-3xl font-bold text-center mb-10">Discount Offers</h2>
            ...
            {currentItems.map((item) => (
              ...
              >
                ...
                <div className="flex items-center space-x-2 mt-1">
                  ...
                  <span className="font-bold text-gray-800">${item.pPrice}</span>
                  {item.oldPrice && (
